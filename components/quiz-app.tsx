...
export function QuizApp({ questions }: QuizAppProps) {
  ...
  const attemptedCount = evaluatedResults.filter((item) => (answers[item.id] ?? "").trim()).length;
      ...
      <div className="mx-auto grid max-w-7xl gap-6 xl:grid-cols-[300px_minmax(0,1fr)]">
        <aside className="xl:sticky xl:top-8 xl:self-start">
          <div className="glass-panel rounded-[28px] p-5">
            <p className="font-display text-2xl font-semibold text-white">FSTE Quiz Hub</p>
            <p className="mt-2 text-sm leading-6 text-white/70">
              Mixed quiz with MCQs, fill in the blanks, and case-study answers from your question bank.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-white/5 p-6 shadow-glow sm:p-8">
            ...
            <div className="relative">
              ...
              <h1 className="mt-3 max-w-3xl font-display text-4xl font-semibold leading-tight text-white sm:text-5xl">
                One clean quiz app for your full FSTE question bank.
              </h1>
              <p className="mt-4 max-w-3xl text-base leading-7 text-white/75">
                Answer each question, jump using the question-number box, and review your score with every wrong
                question listed at the end.
              </p>
            </div>
          </div>
